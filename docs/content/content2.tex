...
la telemetría, el diagnóstico y los controles de seguridad:

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/boceto_pantalla.png}
    \caption{Boceto de la pantalla principal del sistema en tiempo real.
             Elementos: contador FPS, estado de seguridad,
